...
// Assumes type is a UDT
func setUpMapField( debug bool, destField string, mapVar string, vVar string, index string, typeName string, parserOutput parser.ParseOutput  ) string {
	ret := ""
	fields := ""

	tmpVar := createTempVar( typeName )
